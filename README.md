...
7) On the web interface, select your Stratagems to match the ones you choose in game.
...
4) You can use your own profile instead of the one included.
...
5) In HD2SDGK.config, selectorRows/Colums affects the webpage layout.
