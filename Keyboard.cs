...
namespace HD2SDGK
{
    ...
    public class Keyboarda
    {
        ...
        public static void SendKey(DirectXKeyStrokes key, bool KeyUp, InputType inputType)
        {
            ...
            inputs[0].type = (int)inputType;
            inputs[0].wVk = 0;
            inputs[0].wScan = (ushort)key;
            inputs[0].dwFlags = (uint)KeyEventF.Scancode;
            inputs[0].dwExtraInfo = GetMessageExtraInfo();
            ...
            inputs[0].wVk = 0;
            inputs[0].wScan = (ushort)key;
            inputs[0].dwFlags = (uint)(KeyEventF.Scancode | KeyEventF.KeyUp);
            inputs[0].dwExtraInfo = GetMessageExtraInfo();
